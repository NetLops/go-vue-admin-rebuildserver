...
func (c *casbin) Initialize() error {
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/authority/getAuthority", V2: "POST"},
		...
		{Ptype: "p", V0: "888", V1: "/user/setUserIfo", V2: "PUT"},
		...
		{Ptype: "p", V0: "888", V1: "/user/setUsrAuthority", V2: "POST"},
		...
		{Ptype: "p", V0: "888", V1: "/fileUploadDownload/upload", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/fileUploadDownload/deleteFile", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/fileUploadDownload/getFileList", V2: "POST"},
		...
		{Ptype: "p", V0: "888", V1: "/customer/customList", V2: "GET"},
		...
		{Ptype: "p", V0: "888", V1: "/autoCode/getColumn", V2: "POST"},
		...
		{Ptype: "p", V0: "888", V1: "/sysDictionaryDetail/getSysDictionaryList", V2: "GET"},
		...
		{Ptype: "p", V0: "8881", V1: "/casbin/uploadCasbin", V2: "POST"},
		...
		{Ptype: "p", V0: "8881", V1: "/ser/getUserInfo", V2: "GET"},
		...
		{Ptype: "p", V0: "9528", V1: "/authority/getAuthority", V2: "POST"},
