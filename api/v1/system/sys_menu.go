...
// @Param data body request.Empty true "变"
...
func (a *AuthorityMenuApi) UpdateBaseMenu(c *gin.Context) {
	...
	if err := utils.Verify(menu.Meta, utils.MenuVerify); err != nil {
		response.FailWIthMessage(err.Error(), c)
		return
	}
	if err := baseMenuService.UpdateMenu(menu); err != nil {
