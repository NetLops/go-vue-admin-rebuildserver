...
// @Parm data body system.SysAuthority type "权限id，权限名，父角色id"
...
// @accept application/json
// @Produce application/json
// @Oaram data body response.SysAuthorityCopyResponse true "旧角色id，新权限id，新权限名，新父角色id"
// @Success 200 {object} response.Response{data=systemRes.SysAuthorityResponse,msg=string} "拷贝橘色，返回包括系统角色详情"
...
// @Success 200 {object} response.Response{data=string} "设置角色资源权限"
