...
func Zap() (logger *zap.Logger) {
	if ok, _ := utils.PathExists(global.GVA_CONFIG.Zap.Director); !ok { // 判断是否有Directore文件夹
...
// getEncoderConfig 获取 zapcore.EncodeConfig
...
func getEncoderCore(fileName string, level zapcore.LevelEnabler) (core zapcore.Core) {
	writeSyncer := utils.GetWriteSyncer(fileName) // 使用file-rotatelogs进行日志分割
